...
namespace MercaSisBDs
{
    public class BDCliente : ConnectionString
    {
        ...
        public void AlterarCliente(TOCliente cli)
        {
            using (SqlConnection conn = new SqlConnection(strConn))
            {
                ...
                {                    
                    ...
                    SqlParameter pCodigo = new SqlParameter("@codigo", cli.Codigo.Valor);
        ...
        {
            SqlParameter pNome = new SqlParameter("@nome", cli.NomeCompleto.Valor);
            pNome.SqlDbType = SqlDbType.VarChar;
            pNome.Size = 255;
            cmd.Parameters.Add(pNome);

            SqlParameter pCpfCnpj = new SqlParameter("@cpfCnpj", cli.Cpf_Cnpj.Valor);
            pCpfCnpj.SqlDbType = SqlDbType.VarChar;
            pCpfCnpj.Size = 255;
            cmd.Parameters.Add(pCpfCnpj);

            SqlParameter pEntidade = new SqlParameter("@entidade", cli.Entidade.Valor);
            pEntidade.SqlDbType = SqlDbType.VarChar;
            pEntidade.Size = 255;
            cmd.Parameters.Add(pEntidade);

            SqlParameter pSexo = new SqlParameter("@sexo", cli.Sexo.Valor);
            pSexo.SqlDbType = SqlDbType.VarChar;
            pSexo.Size = 1;
            cmd.Parameters.Add(pSexo);

            SqlParameter pDataNascimento = new SqlParameter("@data_nascimento", cli.DataNascimento.Valor);
            pDataNascimento.SqlDbType = SqlDbType.DateTime;
            cmd.Parameters.Add(pDataNascimento);

            SqlParameter pDataCadastro = new SqlParameter("@data_cadastro", cli.DataCadastro.Valor);
            pDataCadastro.SqlDbType = SqlDbType.DateTime;
            cmd.Parameters.Add(pDataCadastro);

            SqlParameter pTelefone = new SqlParameter("@telefone", cli.Telefone.Valor);
            pTelefone.SqlDbType = SqlDbType.VarChar;
            pTelefone.Size = 255;
            cmd.Parameters.Add(pTelefone);

            SqlParameter pTelefoneSec = new SqlParameter("@telefoneSec", cli.TelefoneSec.Valor);
            pTelefoneSec.SqlDbType = SqlDbType.VarChar;
            pTelefoneSec.Size = 255;
            cmd.Parameters.Add(pTelefoneSec);

            SqlParameter pEmail = new SqlParameter("@email", cli.Email.Valor);
            pEmail.SqlDbType = SqlDbType.VarChar;
            pEmail.Size = 255;
            cmd.Parameters.Add(pEmail);

            SqlParameter pSenha = new SqlParameter("@senha", cli.Senha.Valor);
            pSenha.SqlDbType = SqlDbType.VarChar;
            pSenha.Size = 255;
            cmd.Parameters.Add(pSenha);

            SqlParameter pEndereco = new SqlParameter("@endereco", cli.Endereco.Valor);
            pEndereco.SqlDbType = SqlDbType.VarChar;
            pEndereco.Size = 255;
            cmd.Parameters.Add(pEndereco);

            SqlParameter pNumero = new SqlParameter("@numero", cli.Numero.Valor);
            pNumero.SqlDbType = SqlDbType.Int;
            cmd.Parameters.Add(pNumero);

            SqlParameter pComplemento = new SqlParameter("@complemento", cli.Complemento.Valor);
            pComplemento.SqlDbType = SqlDbType.VarChar;
            pComplemento.Size = 255;
            cmd.Parameters.Add(pComplemento);

            SqlParameter pCep = new SqlParameter("@cep", cli.Cep.Valor);
            pCep.SqlDbType = SqlDbType.VarChar;
            pCep.Size = 255;
            cmd.Parameters.Add(pCep);

            SqlParameter pBairro = new SqlParameter("@bairro", cli.Bairro.Valor);
            pBairro.SqlDbType = SqlDbType.VarChar;
            pBairro.Size = 255;
            cmd.Parameters.Add(pBairro);

            SqlParameter pCidade = new SqlParameter("@cidade", cli.Cidade.Valor);
            pCidade.SqlDbType = SqlDbType.VarChar;
            pCidade.Size = 255;
            cmd.Parameters.Add(pCidade);

            SqlParameter pUf = new SqlParameter("@uf", cli.Uf.Valor);
            pUf.SqlDbType = SqlDbType.VarChar;
            pUf.Size = 2;
            cmd.Parameters.Add(pUf);

            SqlParameter pApelido = new SqlParameter("@apelido", cli.Apelido.Valor);
            pApelido.SqlDbType = SqlDbType.VarChar;
            pApelido.Size = 255;
            cmd.Parameters.Add(pApelido);
        ...
        {
            clienteBuscado.Codigo.Valor = (Int32)reader["cli_codigo"];
            clienteBuscado.NomeCompleto.Valor = (string)reader["cli_nome"];
            clienteBuscado.Cpf_Cnpj.Valor = (string)reader["cli_cpfCnpj"];
            if (clienteBuscado.Cpf_Cnpj.Valor.Length > 12)
            {
                clienteBuscado.Entidade.Valor = (string)reader["cli_entidade"];
            }
            clienteBuscado.Sexo.Valor = (string)reader["cli_senha"];
            clienteBuscado.DataNascimento.Valor = (DateTime)reader["cli_dataNascimento"];
            clienteBuscado.Telefone.Valor = (string)reader["cli_telefone"];
            clienteBuscado.TelefoneSec.Valor = (string)reader["cli_telefoneSec"];
            clienteBuscado.Email.Valor = (string)reader["cli_email"];
            clienteBuscado.Senha.Valor = (string)reader["cli_senha"];
            clienteBuscado.Endereco.Valor = (string)reader["cli_endereco"];
            clienteBuscado.Complemento.Valor = (string)reader["cli_complemento"];
            clienteBuscado.Cep.Valor = (string)reader["cli_cep"];
            clienteBuscado.Bairro.Valor = (string)reader["cli_bairro"];
            clienteBuscado.Uf.Valor = (string)reader["cli_estado"];
            clienteBuscado.Apelido.Valor=(string)reader["cli_apelido"];
            return clienteBuscado;
        }
