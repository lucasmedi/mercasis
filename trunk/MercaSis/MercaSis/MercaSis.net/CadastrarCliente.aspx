    ...
    <table style="width:100%; height: 382px;">
        ...
        <tr>
            <td align="right" class="style26">
                Senha:</td>
            <td align="center" class="style5">
                <asp:TextBox ID="txtSenha" runat="server" Width="220px" TextMode="Password"></asp:TextBox>
            </td>
            <td align="center" class="style6">
                &nbsp;</td>
        </tr>
        <tr>
            <td align="right" class="style26">
                Confirma Senha:</td>
            <td align="center" class="style5">
                <asp:TextBox ID="txtConfSenha" runat="server" Width="220px" TextMode="Password"></asp:TextBox>
            </td>
            <td align="center" class="style6">
                &nbsp;</td>
        </tr>
