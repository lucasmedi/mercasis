    ...
    <tr>
        <td class="style1" colspan="2">
            <table style="width: 359%;" align="center">
                ...
                <tr>
                    <td class="style13" align="left">
                        Seu Usuáio:
                        <asp:Label ID="lblUserSenhEr" runat="server" Font-Italic="True" ForeColor="Red" 
            ...
            <asp:TextBox ID="txtUsuario" runat="server" Width="175px"></asp:TextBox>
                ...
                <tr>
                    <td class="style13" align="left">
            <asp:TextBox ID="txtSenha" runat="server" Width="175px" TextMode="Password"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="style13">
                        <asp:LinkButton ID="lkbProsCad" runat="server" onclick="lkbProsCad_Click">Prossegir</asp:LinkButton>
                    </td>
                </tr>
            </table>
        </td>
